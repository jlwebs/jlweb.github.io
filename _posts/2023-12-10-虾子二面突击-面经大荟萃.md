...
### 字节
###### 调用fork函数发生了什么
![image.png]({{site.baseurl}}/images\1699254794689-803c164a-a79b-43fc-b953-4baa1412ddb4.png)
###### copy on Write
###### Nginx网络模型及其惊群问题
...
![image.png]({{site.baseurl}}/images\1699425969060-e35fb60f-4935-4cb8-b26a-6538945a5f4e.png)
...
![image.png]({{site.baseurl}}/images\1699426606875-8d3715de-4539-43ac-821a-567065fe047f.png)
###### tcp拥塞控制算法，BBR思路区别
...
gdb-gui：浏览器调试
![]({{site.baseurl}}/images\1698847535965-f9928c94-b373-4880-b334-d8111ff19245.png)
...
参考TCP-header声明：
![image.png]({{site.baseurl}}/images\1698852667731-68a755bd-7855-4504-8094-8bcfd0617089.png)
![]({{site.baseurl}}/images\1698852710779-b613527c-fa07-4eb4-ae6e-ebe834046e81.png)
通过合理的人为布局设计，完全避免了数据成员cpu两次访问再组合的问题，这时候就可以大胆用#pragma pack(1)，避免不同编译环境下的再排列；

###### 三大进程状态的切换时机总结
![image.png]({{site.baseurl}}/images\1698856221728-f63a5d96-7bef-48dd-abae-7a489cbdaa70.png)
###### 为什么派生类先析构，和构造顺序相反
...
![image.png]({{site.baseurl}}/images\1699085262917-8ebeb0d1-ecb8-4f34-ad47-55952c06c69e.png)
再看看rb-tree查找逻辑（lower_bound）：
![image.png]({{site.baseurl}}/images\1699085362819-491a6d42-8692-4081-a54c-cee4b9294b5b.png)
总结下：基于默认的less我们探讨下查找逻辑
![image.png]({{site.baseurl}}/images\1699085424462-e2b4836d-0ac9-4edd-88b9-aae6db554732.png)
